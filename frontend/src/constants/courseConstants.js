...
export const COURSE_PROF_LIST_REQUEST = 'COURSE_PROF_LIST_REQUEST'
export const COURSE_PROF_LIST_SUCCESS = 'COURSE_PROF_LIST_SUCCESS'
export const COURSE_PROF_LIST_FAIL = 'COURSE_PROF_LIST_FAIL'

export const COURSE_PROF_DETAILS_REQUEST = 'COURSE_PROF_DETAILS_REQUEST'
export const COURSE_PROF_DETAILS_SUCCESS = 'COURSE_PROF_DETAILS_SUCCESS'
export const COURSE_PROF_DETAILS_FAIL = 'COURSE_PROF_DETAILS_FAIL'
